...
public class SpinnerFamilyAdapter extends BaseAdapter {
    private List<UserModel.Data> data;
    private Context context;

    public SpinnerFamilyAdapter(List<UserModel.Data> data, Context context) {
        this.data = data;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        binding.setData(data.get(i).getName());
