...
public class SliderChaletsAdapter extends PagerAdapter {
    private List<UserModel.ImagesData> list;
    private Context context;
    private LayoutInflater inflater;

    public SliderChaletsAdapter(List<UserModel.ImagesData> list, Context context) {
        this.list = list;
